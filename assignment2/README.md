...
> Κ = [Α(L1i\_size\*L1i\_assoc) + B(L1d\_size\*L1d\_assoc) + C(L2\_size\*L2\_assoc)] \* cacheline_size

όπου Α,Β και C σταθερές που περιγράφουν το κατασκευαστικό κόστος της αντίστοιχης cache προς το μέγεθός σε bytes.

Λαμβάνοντας υπόψη ότι

1. Η L1 είναι πιο ακριβή ανα byte από την L2 μπορούμε να θεωρήσουμε οτι A = 2.5 C.
...
> Κ = Α\*[(L1i\_size\*L1i\_assoc) + 2\*(L1d\_size\*L1d\_assoc) + 0.4(L2\_size\*L2\_assoc)] \* cacheline_size
...
Πηγές
*[1] Hennessy and Patterson,Αρχιτεκτονική Υπολογιστών,σελ.610-611.*
